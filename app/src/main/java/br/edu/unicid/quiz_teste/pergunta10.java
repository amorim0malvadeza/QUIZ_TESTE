...
public class pergunta10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fotoPais.setImageResource(R.drawable.turquemenistao);
        ...
        btnResponder.setOnClickListener(v -> {
            ...
            // Na última pergunta, envia a pontuação acumulada para a RankingActivity
            Intent rankingIntent = new Intent(pergunta10.this, ranking.class);
            rankingIntent.putExtra("NOME_USUARIO", nomeUsuario);
            rankingIntent.putExtra("PONTUACAO", pontuacao);
